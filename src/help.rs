...
pub const KEYWORDS: &[Keyword] = &[
    ...
    Keyword {
        name: "step_reduction_multiplier",
        category: KeywordCategory::Convergence,
        description: "Multiplier for RMS gradient threshold in step reduction activation. Step reduction triggers when history norm < rms_g × this value.",
        default_value: Some("10.0"),
        example: Some("step_reduction_multiplier = 10.0"),
        required: false,
    },
    Keyword {
        name: "steepest_descent_step",
        category: KeywordCategory::Convergence,
        description: "Small steepest descent step size (Å) for fallback when DIIS/BFGS produces invalid steps",
        default_value: Some("0.01"),
        example: Some("steepest_descent_step = 0.01"),
        required: false,
    },
    Keyword {
        name: "trust_reduction_factor",
        category: KeywordCategory::Convergence,
        description: "Trust radius contraction factor when energy increases above threshold",
        default_value: Some("0.5"),
        example: Some("trust_reduction_factor = 0.5"),
        required: false,
    },
    Keyword {
        name: "trust_increase_factor",
        category: KeywordCategory::Convergence,
        description: "Trust radius expansion factor when energy decreases below threshold",
        default_value: Some("1.2"),
        example: Some("trust_increase_factor = 1.2"),
        required: false,
    },
    Keyword {
        name: "trust_inc_threshold",
        category: KeywordCategory::Convergence,
        description: "Energy increase threshold (Ha) for trust radius reduction. Increase above this triggers contraction.",
        default_value: Some("0.0001"),
        example: Some("trust_inc_threshold = 0.0001"),
        required: false,
    },
    Keyword {
        name: "trust_dec_threshold",
        category: KeywordCategory::Convergence,
        description: "Energy decrease threshold (Ha) for trust radius increase. Decrease below this triggers expansion.",
        default_value: Some("0.0001"),
        example: Some("trust_dec_threshold = 0.0001"),
        required: false,
    },
    Keyword {
        name: "trust_min_radius",
        category: KeywordCategory::Convergence,
        description: "Minimum allowed trust radius in Å",
        default_value: Some("0.01"),
        example: Some("trust_min_radius = 0.01"),
        required: false,
    },
    Keyword {
        name: "trust_max_radius",
        category: KeywordCategory::Convergence,
        description: "Maximum allowed trust radius in Å",
        default_value: Some("1.0"),
        example: Some("trust_max_radius = 1.0"),
        required: false,
    },
    Keyword {
        name: "print_level",
